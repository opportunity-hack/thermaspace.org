// FLIR One PRO LT (USB-C, 435-0013) cradle + GoPro-STYLE mounts for Meta Quest 3
// ============================= M6 VARIANT =============================
// Identical geometry to flirone-quest3-mount.scad but drilled for M6 bolts
// and wing/hex nuts (6.4 mm clearance hole). Note: standard GoPro hardware
// is M5 — this variant is for M6 bolts; knuckles remain dimensionally
// GoPro-compatible otherwise. Use an M6 x 25-30 mm bolt + wing nut.
// =========================================================================
...
GP_HOLE     = 6.4;   // M6 through-hole (ISO clearance)
